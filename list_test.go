				...
				Results: []Document{
					{
						...
						FirstOpenedAt: timePtr(time.Date(2024, 1, 15, 10, 0, 0, 0, time.UTC)),
						LastOpenedAt:  timePtr(time.Date(2024, 1, 20, 15, 30, 0, 0, time.UTC)),
						SavedAt:       timePtr(time.Date(2024, 1, 10, 8, 0, 0, 0, time.UTC)),
						LastMovedAt:   timePtr(time.Date(2024, 1, 12, 9, 0, 0, 0, time.UTC)),
					...
					},
					{
						...
						SiteName:      "Tech Blog",
						FirstOpenedAt: timePtr(time.Date(2024, 1, 18, 14, 0, 0, 0, time.UTC)),
						LastOpenedAt:  timePtr(time.Date(2024, 1, 22, 16, 45, 0, 0, time.UTC)),
						SavedAt:       timePtr(time.Date(2024, 1, 17, 10, 0, 0, 0, time.UTC)),
						LastMovedAt:   timePtr(time.Date(2024, 1, 19, 11, 30, 0, 0, time.UTC)),
				...
				Results: []Document{
					{
						...
						SavedAt:       timePtr(time.Date(2024, 2, 1, 10, 0, 0, 0, time.UTC)),
